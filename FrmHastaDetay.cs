...
namespace Proje_Hastane
{
    public partial class FrmHastaDetay : Form
    {
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            ...
            {
                //Application.Exit();
                FrmHastaGiris gecis = new FrmHastaGiris();
                gecis.ShowDialog();
            }
        }
        ...
        {
            DialogResult x = MessageBox.Show("Hasta Detay Panelinden Çıkış Yapmak İstediğinizden Emin Misiniz?", "Çıkış Mesajı!", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
